    ...
    <footer className='footer'>
      <div className='footer__container'>
        ...
        <section className='footer__middle'>
          ...
          <p className='footer__middleCopy'>&copy; Sports Shoes 2024. All Right Reserved</p>
        </section>
        <section className='footer__right'>
        <ul className='footer__rightList'>
            <li className='footer__rightItem'>
              <a href="https://github.com/sammy3110/react-ecommerce-app" className='footer__rightLink'><i className='bx bxl-facebook-circle' ></i></a>
            </li>
            <li className='footer__rightItem'>
